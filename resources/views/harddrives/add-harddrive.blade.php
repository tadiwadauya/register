            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Create Hard Drive</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => 'harddrives.store', 'method' => 'POST', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('capacity', NULL, array('id' => 'capacity', 'class' => 'name-group', 'placeholder' => 'e.g. 500GB ')) !!}
                                </div>
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Add Hard Drive', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
