            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Modify Hard Drive</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['harddrives.update',$harddrive->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                    ...
                    <div class="j-content">
                            ...
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="brand" id="brand">
                                        <option value="{{$harddrive->brand}}">{{$harddrive->brand}}</option>
                                        @if ($brands)
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('model', $harddrive->model, array('id' => 'model', 'class' => 'name-group', 'placeholder' => 'e.g. XL12345')) !!}
                                </div>
                                @if ($errors->has('model'))
                                    <span class="help-block">
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('serial', $asset->serial, array('id' => 'serial', 'class' => 'name-group', 'placeholder' => 'e.g. DB1233445 ')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    <label class="j-label" for="capacity">
                                        Capacity
                                    </label>
                                    {!! Form::text('capacity', $harddrive->capacity, array('id' => 'capacity', 'class' => 'name-group', 'placeholder' => 'e.g. 500GB ')) !!}
                                </div>
                        ...
                        <div class="j-unit">
                            <div class="j-input">
                                ...
                                @endif
                                <span class="j-tooltip j-tooltip-right-top">Any additional info, like the reason why the harddrive was bought, etc</span>
                            </div>
                        </div>
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Hard Drive', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
