            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Create Job Title</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => 'jobtitles.store', 'method' => 'POST', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('jobtitle', NULL, array('id' => 'jobtitle', 'class' => 'name-group', 'placeholder' => 'e.g. Systems Developer')) !!}
                                </div>
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Add Job Title', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
