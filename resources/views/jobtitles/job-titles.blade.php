            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/jobtitles')}}">Job Titles</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Job Titles</h5>
                <span>Whelson User Job Titles</span>
                <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                        <a href="{{ url('jobtitles/create') }}" class="btn btn-round btn-light float-right">
                        ...
                        @foreach($jobtitles as $jobtitle)
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    {!! Form::open(array('url' => 'jobtitles/' . $jobtitle->id, 'class' => 'btn btn-mini')) !!}
                                    {!! Form::hidden('_method', 'DELETE') !!}
                                    {!! Form::button('<i class="feather icon-trash-2"></i>', array('class' => 'btn btn-danger btn-mini','type' => 'button','data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Job Title', 'data-message' => 'Are you sure you want to delete this job title ?')) !!}
                                    {!! Form::close() !!}

                                    <a class="btn btn-primary btn-mini" href="{{ URL::to('jobtitles/' . $jobtitle->id . '/edit') }}" >
