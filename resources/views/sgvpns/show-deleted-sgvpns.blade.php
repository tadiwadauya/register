...
@section('template_title')
    Showing All Deleted SG VPN Accounts
@endsection
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Deleted SG VPN Accounts</h4>
                        <span>All Deleted SG VPN Accounts</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/sgvpns/deleted')}}">Deleted SG VPN Accounts</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <table id="vince-tables" class="table table-striped table-bordered nowrap" >
                        ...
                        @foreach($sgvpns as $sgvpn)
                            <tr>
                                ...
                                <td>{{$sgvpn->deleted_at}}</td>
                                <td style="white-space: nowrap;">
                                    {!! Form::model($sgvpn, array('action' => array('SoftDeleteSgvpnController@update', $sgvpn->id), 'method' => 'PUT')) !!}
                                    ...
                                    {!! Form::model($sgvpn, array('action' => array('SoftDeleteSgvpnController@destroy', $sgvpn->id), 'method' => 'DELETE', 'class' => 'inline')) !!}
