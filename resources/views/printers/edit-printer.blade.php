        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['printers.update',$printer->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                    ...
                    <div class="j-content">
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('model', $printer->model, array('id' => 'model', 'class' => 'name-group', 'placeholder' => 'e.g. XL12345')) !!}
                                </div>
                                @if ($errors->has('model'))
                                    <span class="help-block">
                        ...
                        <div class="j-unit">
                            <div class="j-input">
                                ...
                                @endif
                                <span class="j-tooltip j-tooltip-right-top">Any additional info, like the reason why the printer was bought, where its being used, etc</span>
                            </div>
                        </div>
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Printer', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
