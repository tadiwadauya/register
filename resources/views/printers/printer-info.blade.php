            ...
            <div class="col-md-12">
                <div class="card product-detail-page">
                    <div class="card-header">
                        ...
                        <span>Printer assigned to {{$yuser->first_name}} {{$yuser->last_name}}</span>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-lg-12 col-xs-12 product-detail" id="product-detail">
                                    <div class="col-lg-12">
                                        <span class="txt-muted d-inline-block">Printer Asset Tag: <strong>{{$printer->assettag}}</strong> </span>
