        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Departments</h4>
                        <span>Modifying Department</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Modifying Department</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['departments.update',$department->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('department', $department->department, array('id' => 'department', 'class' => 'name-group', 'placeholder' => 'e.g. I.T')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="asst_manager" id="asst_manager">
                                        <option value="{{$department->asst_manager}}">{{$department->asst_manager}}</option>
                                        @if ($users)
                                            @foreach($users as $user)
                                                <option value="{{ $user->paynumber }}" >{{ $user->first_name }} {{ $user->last_name }} - {{ $user->paynumber }}</option>
                                            @endforeach
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Department', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
