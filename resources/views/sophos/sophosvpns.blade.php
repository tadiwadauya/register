        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Sophos VPN</h4>
                        <span>Sophos user accounts</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/sophosvpns')}}">Sophos</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                        <a href="{{ url('sophosvpns/create') }}" class="btn btn-round btn-light float-right">
                            <i class="feather icon-plus" aria-hidden="true"></i>
                            Add Sophos Account
                        </a>
                        &nbsp;
                        <a href="{{ url('sophosvpns/deleted') }}" class="btn btn-round btn-danger float-right">
                            <i class="feather icon-trash" aria-hidden="true"></i>
                            Deleted Sophos Accounts
                        </a>
                    </ul>
                </div>
            </div>
                        ...
                        @foreach($sophosvpns as $sophosvpn)
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    {!! Form::open(array('url' => 'sophosvpns/' . $sophosvpn->id, 'class' => 'btn btn-mini')) !!}
                                    {!! Form::hidden('_method', 'DELETE') !!}
                                    {!! Form::button('<i class="feather icon-trash-2"></i>', array('class' => 'btn btn-danger btn-mini','type' => 'button','data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Sophos Acoount', 'data-message' => 'Are you sure you want to delete this account ?')) !!}
                                    {!! Form::close() !!}

                                    {{--<a class="btn btn-success btn-mini" href="{{ URL::to('sophosvpns/' . $sophosvpn->id) }}" >
                                        <i class="feather icon-eye"></i>
                                    </a>--}}

                                    <a class="btn btn-primary btn-mini" href="{{ URL::to('sophosvpns/' . $sophosvpn->id . '/edit') }}" >
