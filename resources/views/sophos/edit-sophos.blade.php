            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Modify Sophos Account</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Modifying Sophos Account for {{$sophosvpn->employee}}</h5>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['sophosvpns.update',$sophosvpn->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('employee', $sophosvpn->employee, array('id' => 'employee', 'class' => 'name-group', 'placeholder' => 'e.g. Vincent Guyo', 'readonly')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('user', $sophosvpn->user, array('id' => 'user', 'class' => 'name-group', 'placeholder' => 'e.g. vincent', 'readonly')) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('password', $sophosvpn->password, array('id' => 'password', 'class' => 'name-group', 'placeholder' => 'e.g. VeryStrongPassword')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="status" id="status">
                                        <option value="{{$sophosvpn->status}}">{{$sophosvpn->status}}</option>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="accounttype" id="accounttype">
                                        <option value="{{$sophosvpn->accounttype}}">{{$sophosvpn->accounttype}}</option>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <input type="text" value="{{$sophosvpn->updated_at}} " readonly>
                                </div>
                            </div>
                        </div>
