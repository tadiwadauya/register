            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/brands')}}">Brands</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                        <a href="{{ url('brands/create') }}" class="btn btn-round btn-light float-right">
                        ...
                        @foreach($brands as $brand)
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    {!! Form::open(array('url' => 'brands/' . $brand->id, 'class' => 'btn btn-mini')) !!}
                                    {!! Form::hidden('_method', 'DELETE') !!}
                                    {!! Form::button('<i class="feather icon-trash-2"></i>', array('class' => 'btn btn-danger btn-mini','type' => 'button','data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Brand', 'data-message' => 'Are you sure you want to delete this brand ?')) !!}
                                    {!! Form::close() !!}

                                    <a class="btn btn-success btn-mini" href="{{ URL::to('brands/' . $brand->id) }}" >
                                        <i class="feather icon-eye"></i>
                                    </a>

                                    <a class="btn btn-primary btn-mini" href="{{ URL::to('brands/' . $brand->id . '/edit') }}" >
