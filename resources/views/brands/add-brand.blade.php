        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => 'brands.store', 'method' => 'POST', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('brand', NULL, array('id' => 'brand', 'class' => 'name-group', 'placeholder' => 'e.g. Lenovo')) !!}
                                </div>
                                @if ($errors->has('brand'))
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Add Brand', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
