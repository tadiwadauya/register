        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Maintenance</h4>
                        <span>Modify Maintenance Log</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Manually Modifying Maintenance Entry</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Modifying Maintenance Log </h5>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['maintenances.update',$maintenance->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="username" id="username">
                                        <option value="{{$maintenance->username}}">{{$maintenance->username}}</option>
                                        @if ($users)
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('ip_address', $maintenance->ip_address, array('id' => 'ip_address', 'class' => 'name-group ipv4', 'placeholder' => 'e.g. 192.168.1.23', 'data-mask' => '99/99/9999 99:99:99')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('department', $maintenance->department, array('id' => 'department', 'class' => 'name-group', 'placeholder' => 'e.g. I.T.', 'readonly')) !!}
                                </div>
                            ...
                            <div class="j-unit">
                                ...
                                <div class="border-checkbox-section">
                                    <div class="border-checkbox-group border-checkbox-group-success">
                                        <input class="border-checkbox" type="checkbox" id="monitor" name="monitor" value="@if($maintenance->monitor == true )1 @else 0 @endif" @if($maintenance->monitor == true ) checked="checked" @endif>
                                        <label class="border-checkbox-label" for="monitor">Monitor Cleaned?</label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-success">
                                        <input class="border-checkbox" type="checkbox" id="cpu" name="cpu" value="@if($maintenance->cpu == true )1 @else 0 @endif" @if($maintenance->cpu == true ) checked="checked" @endif>
                                        <label class="border-checkbox-label" for="cpu">CPU Cleaned?</label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-success">
                                        <input class="border-checkbox" type="checkbox" id="keyboard" name="keyboard" value="@if($maintenance->keyboard == true )1 @else 0 @endif" @if($maintenance->keyboard == true ) checked="checked" @endif>
                                        <label class="border-checkbox-label" for="keyboard">Keyboard Cleaned?</label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-success">
                                        <input class="border-checkbox" type="checkbox" id="mouse" name="mouse" value="@if($maintenance->mouse == true )1 @else 0 @endif" @if($maintenance->mouse == true ) checked="checked" @endif>
                                        <label class="border-checkbox-label" for="mouse">Mouse Cleaned?</label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-success">
                                        <input class="border-checkbox" type="checkbox" id="desk" name="desk" value="@if($maintenance->desk == true )1 @else 0 @endif" @if($maintenance->desk == true ) checked="checked" @endif>
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Entry', array('id'=>'checkBtn','class' => 'btn btn-primary','type' => 'submit' )) !!}
