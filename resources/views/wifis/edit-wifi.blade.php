        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>WiFi</h4>
                        <span>Modify {{$wifi->wifi}} WiFi</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Modify WiFi</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['wifis.update',$wifi->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                    ...
                    <div class="j-content">
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('wifi', $wifi->wifi, array('id' => 'wifi', 'class' => 'form-control', 'placeholder' => 'e.g. WhelsonMainWifi')) !!}
                                </div>
                                @if ($errors->has('wifi'))
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('location', $wifi->location, array('id' => 'location', 'class' => 'form-control', 'placeholder' => 'e.g. Accounts Office')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('password', $wifi->password, array('id' => 'password', 'class' => 'form-control', 'placeholder' => 'e.g. VeryStrongPassword')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('username', $wifi->username, array('id' => 'username', 'class' => 'form-control', 'placeholder' => 'e.g. Root')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('router_pwd', $wifi->router_pwd, array('id' => 'router_pwd', 'class' => 'form-control', 'placeholder' => 'e.g. IAmAStrongPassword')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('router_ip', $wifi->router_ip, array('id' => 'router_ip', 'class' => 'form-control', 'placeholder' => 'e.g. 192.168.1.23. Use 0.0.0.0 for DHCP wifis')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('ip_range', $wifi->ip_range, array('id' => 'ip_range', 'class' => 'form-control', 'placeholder' => 'e.g. 192.168.10.2-254')) !!}
                                </div>
                        ...
                        <div class="j-unit">
                            <div class="j-input">
                                ...
                                {!! Form::textarea('comments', $wifi->comments, array('id' => 'comments', 'class' => 'name-group', 'placeholder' => 'e.g. Any comments about the wifi network','spellcheck'=>'true')) !!}
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Wi-Fi', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
