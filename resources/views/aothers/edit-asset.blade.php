            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Modify Asset</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['aothers.update',$aother->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                            ...
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="type" id="type">
                                        <option value="{{$aother->type}}">{{$aother->type}} </option>
                            ...
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="brand" id="brand">
                                        <option value="{{$aother->brand}}">{{$aother->brand}}</option>
                                        @if ($brands)
                        ...
                        <div class="j-row">
                            <div class="j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('model', $aother->model, array('id' => 'model', 'class' => 'name-group', 'placeholder' => 'e.g. XL12345')) !!}
                                </div>
                                @if ($errors->has('model'))
                                    <span class="help-block">
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Asset', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
