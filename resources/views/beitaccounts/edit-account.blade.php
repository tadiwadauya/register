            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/beitaccounts')}}">Beit O365</a></li>
                        <li class="breadcrumb-item"><a href="#!">Modify Beit O365 Account</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Modifying Beit O365 Account </h5>
                <div class="card-header-right">
                    <a href="{{ url('/beitaccounts') }}" class="btn btn-round btn-light float-right">
                        <i class="feather icon-chevrons-left" aria-hidden="true"></i>
                        Back to Beit O365 List
                    </a>
                </div>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['beitaccounts.update',$beitaccount->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="user" id="user">
                                        <option value="{{$beitaccount->user}}">{{$beitaccount->user}}</option>
                                        @if ($users)
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::email('email', $beitaccount->email, array('id' => 'email', 'class' => 'name-group', 'placeholder' => 'e.g. user@beitbridge.whelson.co.zm')) !!}
                                </div>
                                @if ($errors->has('email'))
                                    <span class="help-block">
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('password', $beitaccount->password, array('id' => 'password', 'class' => 'name-group', 'placeholder' => 'e.g. VeryStrongPassword')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('prev_password', $beitaccount->prev_password, array('id' => 'prev_password', 'class' => 'name-group', 'placeholder' => 'e.g. VeryStrongPassword')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <input type="text" value="{{$beitaccount->last_agent}} @ {{$beitaccount->updated_at}} " readonly>
                                </div>
                            </div>
