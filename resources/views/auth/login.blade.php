                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center">Whelson IT Register</h3>
                                </div>
                            </div>
                            <div class="form-group form-primary">
                                <input type="text" name="login" id="login" class="form-control{{ $errors->has('paynumber') || $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Pay Number or Email"
                                       value="{{ old('paynumber') ?: old('email') }}" required autofocus>
