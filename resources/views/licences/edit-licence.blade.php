            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Modify Licence</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => ['licences.update',$licence->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('licname', $licence->licname, array('id' => 'licname', 'class' => 'name-group', 'placeholder' => 'e.g. ESET Endpoint Protection Standard')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('lickey', $licence->lickey, array('id' => 'lickey', 'class' => 'name-group', 'placeholder' => 'e.g. ZXCV-BNMA-SDFG-HJKL')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('software', $licence->software, array('id' => 'software', 'class' => 'name-group', 'placeholder' => 'e.g. Eset Antivirus')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('lic_users', $licence->lic_users, array('id' => 'lic_users', 'class' => 'name-group', 'placeholder' => 'e.g. 100 Computers')) !!}
                                </div>
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('expirydate', $licence->expirydate, array('id' => 'dropper-animation', 'class' => 'name-group', 'placeholder' => 'e.g. 2020-01-31')) !!}
                                </div>
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('date_bought', $licence->date_bought, array('id' => 'date_bought', 'class' => 'name-group', 'placeholder' => 'e.g. 2019-01-31')) !!}
                                </div>
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Update Licence', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
