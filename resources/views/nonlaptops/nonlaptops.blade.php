...
@section('template_title')
    Showing All Non Allocated Laptops
@endsection
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        ...
                        <span>All Non allocated Laptops</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/laptops')}}">Non allocated Laptops</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Non allocated Laptops</h5>
                <span>Non allocated Laptops</span>
            ...
            <div class="card-block">
                <div class="dt-responsive table-responsive">
                    <table id="vince-tables" class="table table-striped table-bordered nowrap" >
                        ...
                        <tbody>
                        @foreach($nonlaptops as $nonlaptop)
                            @php $assets = \App\Models\Asset::all()->where('assettag', $nonlaptop->assettag );
                            ...
                            <tr>
                                ...
                                @endforeach
                                <td>{{$nonlaptop->assettag}}</td>
                                <td style="white-space: nowrap;">
                                    {!! Form::open(array('url' => 'laptops/' . $nonlaptop->id, 'class' => 'btn btn-mini')) !!}
                                    ...
                                    <a class="btn btn-success btn-mini" href="{{ URL::to('laptops/' . $nonlaptop->id) }}" >
                                        <i class="feather icon-eye"></i>
                                    </a>

                                    <a class="btn btn-primary btn-mini" href="{{ URL::to('laptops/' . $nonlaptop->id . '/edit') }}" >
